import Vue from 'vue';
import { Table, TableColumn, Checkbox, Switch, Form, FormItem, Input, InputNumber, Select, Option, RadioGroup, CheckboxGroup, Radio, DatePicker, TimeSelect, TimePicker } from 'element-ui';
...
var __vue_render__$1 = function __vue_render__() {
  ...
  }, "el-table", Object.assign({}, _vm.tableProps), false), [_vm.$listeners["selection-change"] ? _c("el-table-column", { attrs: { type: "selection", width: "55" } }) : _vm._e(), _vm._v(" "), _vm._l(_vm.columns, function (ref, i) {
    ...
    return _c("el-table-column", _vm._b({
      ...
      scopedSlots: _vm._u([{
        ...
        fn: function fn(scope) {
          return [_vm.$scopedSlots[dataIndex] ? _vm._t(dataIndex, null, { scope: scope }) : _c("span", [_vm._v(_vm._s(render ? render(scope.row) : scope.row[dataIndex]))])];
        }
      }], null, true)
...
var __vue_render__$2 = function __vue_render__() {
  ...
  return _c("el-form", _vm._b({
  ...
  }, "el-form", Object.assign({}, _vm.props), false), [_vm._l(_vm.items, function (item, index) {
    ...
    }, "el-date-picker", Object.assign({}, item.props), false)) : _vm._e()], 1);
...
var index = { version: version, install: install, HelloWorld: __vue_component__, JcBaseTable: __vue_component__$1, JcBaseFrom: __vue_component__$2 };
